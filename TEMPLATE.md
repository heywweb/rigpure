...
|---|---|---|
| `RigPure` | `brand` | `BlogStarter` |
| `PC gaming reviews, guides and news` | `niche` | `specialty coffee brewing` |
| `rigpure` | slug de `brand` (kebab-case) | `blogstarter` |
| `rigpure.com` | `domain` | `votreblog.com` |
| `en` | `language` | `en` |
| `Alex` | `authors[0].name` | `Alex` |
| `alex` | slug de `authors[0].name` | `alex` |
| `PC gaming reviewer — plays and tests every title covered before writing.` | `authors[0].bio` | `…` |
